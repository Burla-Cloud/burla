...
//   () => logs.some((e) => e.index !== null && e.index !== undefined),
//   [logs]
// );
...
//   // Older jobs: logs exist but they have no per-input index
//   if (logs.length > 0 && !hasAnyIndexedLogs) {
//     result.push({
//       type: "empty",
//       key: "no-index",
//       label: "This job produced no log output",
//     });
//     return result;
//   }
...
//   return result;
// }, [logs, selectedIndex, hasAnyIndexedLogs]);

// const stepperDisabled =
//   isPageLoading ||
//   items.length === 1 && (items[0].type === "empty"); // covers "No logs..." and "older job format" message
...
//               <button type="button" onClick={goPrev} disabled={stepperDisabled} className={navBtnClass(stepperDisabled)}>
//                 {"<"}
//               </button>
//               <span className="tabular-nums">
//                 {displayIndex} / {displayTotal || 0}
//               </span>
//               <button type="button" onClick={goNext} disabled={stepperDisabled} className={navBtnClass(stepperDisabled)}>
//                 {">"}
//               </button>
//             </div>
...
//                 }}
//                 disabled={failedIndexes.length === 0 || stepperDisabled}
