...
import { Plus, Trash2, RefreshCw, Clipboard, Eye, EyeOff, Check, InfoIcon } from "lucide-react";
                            ...
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    <p>
                                        ...
                                        <br />
                                        Used to call Burla in environments where `burla login`
                                        cannot be run.
                                        <br />
                                        Service Accounts are used to represent web-services instead
                                        of users.
                                    </p>
                                </TooltipContent>
                            </Tooltip>
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-4 justify-end">
                                        <div className="relative flex flex-col items-center">
                                            ...
                                            <button
                                                onClick={() => handleCopy(acc.token, acc.id)}
                                                title="Copy"
                                            >
                                                {copiedTokenIds.has(acc.id) ? (
                                        ...
                                        >
                                            <div className="relative flex flex-col items-center">
                                                {refreshedTokenIds.has(acc.id) && (
                                                    <ActionTooltip label="Refreshed!" />
                                                )}
                                                <button
                        ...
                        <table className="w-full text-sm text-left table-auto">
                            {accounts.length > 0 && (
                                <thead className="border-b bg-white">
                                    <tr>
                                        <th className="p-2"></th>
                                        <th className="p-2 pl-4 text-sm font-medium text-gray-500">
                                            Name
                                        </th>
                                        <th className="p-2 pl-4 text-sm font-medium text-gray-500">
                                            Token
                                ...
                                {accounts.length === 0 ? (
                                    ...
                                    accounts.map((acc) => (
                                        <tr key={acc.id} className="border-b hover:bg-gray-50">
                                            ...
                                            <td className="p-2 pl-4 align-middle text-sm text-gray-700">
                                                {acc.name}
                                            </td>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {visibleTokens.has(acc.id) ? (
                                                                ...
                                                                <span className="opacity-60 select-none block">
                                                                    {"•".repeat(100)}
                                                                </span>
                                                            )}
                                                        </div>
