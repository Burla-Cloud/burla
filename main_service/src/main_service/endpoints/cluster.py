            ...
            while m < window_end:
                ...
                if seg_end > seg_start:
                    ...
                    if mk in compute_buckets:
                        compute_buckets[mk][group_key] = compute_buckets[mk].get(group_key, 0.0) + (raw_hours * mult)
            ...
            while d < window_end:
                ...
                if seg_end > seg_start:
                    ...
                    if dk in compute_buckets:
                        compute_buckets[dk][group_key] = compute_buckets[dk].get(group_key, 0.0) + (raw_hours * mult)
