...
# where that env dir is a slow Docker Desktop bind mount, this legitimately takes minutes.
...
# VMs (node_service is a host process reading the root cgroup), and never
# read in local-dev, where the monitor is disabled like the RAM one.
...
async def cpu_pressure_monitor_loop():
    ...
    for worker in _active_dynamic_workers():
        try:
            ...
            pass  # worker_server.py mid-relaunch; the loop below handles it
    ...
    async def _start_container(self):
        ...
        config = {
            ...
            "Env": [
                ...
                # near-network-free. Copy mode: hardlinks can't cross the
                # cache/env bind mounts.
